...
namespace CollectionsExercisesTests
{
    public class DictionaryTests
    {
        ...
        {
            var result = CollectionsExercises.CollectionsExercises.CountDigits(input);
    ...
    public class QueueTest
    {
        ...
        public void GivenANumber_NextInQueue_ReturnsCorrectNames(int num, string expectedNames)
        {
            ...
            var result = CollectionsExercises.CollectionsExercises.NextInQueue(num, _queue);
        ...
        {
            var result = CollectionsExercises.CollectionsExercises.NextInQueue(7, _queue);
    ...
    public class StackTest
    {
        ...
        {
            int[] array = { };
            var result = CollectionsExercises.CollectionsExercises.Reverse(array);
